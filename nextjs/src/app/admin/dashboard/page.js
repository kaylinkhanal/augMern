...
const Dashboard = () => {
	return (
		<div className="flex pl-8 pt-4 gap-4 flex-col w-full bg-blue-600">
			...
			<div className="flex bg-red-600 gap-24">
				<div className="w-3/5">
					<input
			...
			<div className=" flex gap-8">
				<span className="flex flex-col bg-yellow-100 hover:bg-yellow-200 h-48 w-44 shadow-md justify-center text-center p-4 rounded-2xl font-family='verdana'">
					Total Students<span className="font-bold">15000</span>
				</span>
				<span className="flex flex-col bg-green-100 hover:bg-yellow-200 h-48 w-44 shadow-md justify-center text-center p-4 rounded-2xl font-family='verdana'">
					Total Teachers<span className="font-bold">120</span>
				</span>
				<span className="flex flex-col bg-red-100 hover:bg-yellow-200 h-48 w-44 shadow-md justify-center text-center p-4 rounded-2xl font-family='verdana'">
					Total Parents<span className="font-bold">2500</span>
				</span>
				<span className="flex flex-col bg-blue-100 hover:bg-yellow-200 h-48 w-44 shadow-md justify-center text-center p-4 rounded-2xl font-family='verdana'">
					Total Earnings<span className="font-bold">$1600000</span>
				</span>

				{/* * 2 cards right side of 4 cards
				<div className=" flex gap-8 ml-4 flex-col mt-2">
					<div className="flex flex-col h-80 w-64 bg-gray-100 hover:bg-gray-200 rounded-2xl "></div>

					<div className="flex flex-col h-60 w-64 bg-gray-100 hover:bg-gray-200 rounded-2xl "></div>
				</div> */}
			</div>
			{/**--------2cards-below-4 cards */}
			<div className=" flex float-left gap-8 mt-8">
